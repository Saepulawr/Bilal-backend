...
return [
    'service_manager' => [
        ...
        'aliases' => [
            ...
            'ZF\\OAuth2\\Adapter\\IbmDb2Adapter' => 'Laminas\\ApiTools\\OAuth2\\Adapter\\IbmDb2Adapter',
    ...
    'asset_manager' => [
        'resolver_configs' => [
            'paths' => [
                '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/vendor/laminas-api-tools/api-tools/config/../asset'
            ]
        ]
    ],
    'api-tools' => [
    ...
    'view_manager' => [
        'template_path_stack' => [
            '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/vendor/laminas-api-tools/api-tools-documentation/config/../view',
            '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/vendor/laminas-api-tools/api-tools-oauth2/config/../view',
            '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/module/Application/config/../view'
        ],
        'display_exceptions' => true,
        'template_map' => [
            'oauth/authorize' => '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/vendor/laminas-api-tools/api-tools-oauth2/config/../view/laminas/auth/authorize.phtml',
            'oauth/receive-code' => '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/vendor/laminas-api-tools/api-tools-oauth2/config/../view/laminas/auth/receive-code.phtml',
            'layout/layout' => '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/module/Application/config/../view/layout/layout.phtml',
            'application/index/index' => '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/module/Application/config/../view/application/index/index.phtml',
            'error/404' => '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/module/Application/config/../view/error/404.phtml',
            'error/index' => '/opt/lampp/htdocs/bilal/backend/api-tools-skeleton/module/Application/config/../view/error/index.phtml'
        ],
